...
<html lang="en">
  ...
  <body>
    ...
    <div id="sign_in">
      <form action="logsal" method="post">
        <span>Login</span>
        <div id="field">
    ...
    <div id="sign_up">
      <form method="post" action="insertsalon">
        <span>Sign Up as salon</span>
        
        <div id="field">
            <label><i class="fas fa-user"></i></label>
            <input type="number" placeholder="Salon Registration Number" name="reg_id" required />
          </div>

          <div id="field">
            <label><i class="fas fa-user"></i></label>
            <input type="text" placeholder="Salon Name" name="name" required />
          </div>

          
          <div id="field">
            <label><i class="fas fa-user"></i></label>
            <input type="text" placeholder="Salon Address" name="address" required />
          </div>
        
          <div id="field">
            <label><i class="fas fa-user"></i></label>
            <input type="number" placeholder="salon Mobile" name="mobile" required />
          </div>
          ...
          <div id="field">
            <label><i class="fas fa-envelope-open"></i></label>
            <input type="number" placeholder="No. of Stylist" name="no_of_stylist" required />
          </div>
    ...
    <script src="js/min/signinsalon.js"></script>
  </body>
</html>
