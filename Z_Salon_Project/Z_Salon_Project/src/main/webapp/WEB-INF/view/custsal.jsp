...
<body class="homepage header-collapse">
	...
	<div id="site-content">
		...
		<header class="site-header">
			<div class="container">
				<a id="branding" href="index.html"> <img src="images/logo.png"
					alt="Company name" class="logo">
					<div class="logo-copy">
						<h1 class="site-title">Transition Salon</h1>
						<small class="site-description">Transition Salon
      ...
      <div class="grid-item">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <a href="cservc">
             <button  class="card-btn">Services</button></a>
          </div>
        </div>
      </div>
      <div class="grid-item">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <button href="custserv" class="card-btn">Services</button>
          </div>
        </div>
      </div>
      <div class="grid-item">
        <div class="card">
          ...
          <div class="card-content">
            ...
            <button href="#" class="card-btn">Services</button>
          </div>
        </div>
      </div>
    </div>
